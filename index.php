...
<body>
  ...
  <nav class="theme-color-bg show-on-small hide-on-med-only hide-on-large-only">
    <div class="nav-wrapper">
      <a href="index.php" class="brand-logo center">ROOMS</a>
  ...
  <div class="avl-container">
	...
	<div class="tagline">
		...
		<p class="flow-text">Rooms is a platform for easy and efficient communication between seller and buyer. We have earned the trust of our buyers thanks to our secure system. 
		...
		<div class="avl-container">
			<div class="row">
				<div class="col l6 s12 pd-0 tagicon">
					<h4 class="white-text"><b>ROOMS</b></h4>
